...
Since the datasets are all normally distributed, mean + 3SD will be used to develop the grossrange thresholds. Stations have similar mean + SD, so data has been pooled to determine one threshold to be used to flag all inland river datasets.
