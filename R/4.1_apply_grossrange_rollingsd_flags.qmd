---
title: "Apply grossrange and rollingsd flags to Inland data"
format:
  html:
    toc: true
    toc-depth: 3
...
Use this document to apply grossrange and rollingsd flags to all inland data and visualize flagged plots. The output will be used as an input for exploring human in the loop flags. 
...
# update the tracking sheet at: "R:\tracking_sheets\2024-10-17_inland_water_quality_human_in_loop_tracking.xlsx" to add human in the loop flags

# Your thresholds analysis is complete
```
